...
- The app directory should at least contain the following files:
  - `index.html`
  - `screenly.yml`
- See [this documentation about getting started with Edge Apps](https://developer.screenly.io/edge-apps/#getting-started) for details.
...
`screenly.signalReadyForRendering()` tells the device that the Edge App is ready to be displayed on the screen. See this [documentation about the ready signal](https://developer.screenly.io/edge-apps/#ready-signal) for details.
...
- This project uses [Super Linter](https://github.com/github/super-linter) for linting.
